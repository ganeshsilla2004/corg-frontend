...
import "../styles/wordpresshare.css";
import "../styles/wordpresshare-m.css";
import Navbar from "../components/Navbar";
import Footer from "../components/Footer";

const WordpressShared: React.FC = () => {
  return (
    <div>
      ...
      <div className="heading">
        <h1>WordPress Shared Hosting</h1>
      </div>
      ...
      <div className="img">
        <img src="/assets/sharedhosting.png" alt="WordPress Shared Hosting" />
      </div>

      <div className="mob1">
        <img
          src="/assets/sharedhostingmob.png"
          alt="WordPress Shared Hosting Mobile"
        />
      </div>
...
export default WordpressShared;